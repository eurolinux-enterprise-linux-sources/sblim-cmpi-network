...
#ifdef CMPI_VER_100
#define OSBase_CSNetworkPortProviderSetInstance OSBase_CSNetworkPortProviderModifyInstance 
#endif


/* ---------------------------------------------------------------------------*/

static char * _ClassName     = "Linux_CSNetworkPort";
static char * _RefLeft       = "GroupComponent";
static char * _RefRight      = "PartComponent";
static char * _RefLeftClass  = "Linux_ComputerSystem";
static char * _RefRightClass = "CIM_NetworkPort";
...
CMPIStatus OSBase_CSNetworkPortProviderCleanup( CMPIInstanceMI * mi, 
...
CMPIStatus OSBase_CSNetworkPortProviderEnumInstanceNames( CMPIInstanceMI * mi, 
...
CMPIStatus OSBase_CSNetworkPortProviderEnumInstances( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
           const CMPIObjectPath * ref, 
...
CMPIStatus OSBase_CSNetworkPortProviderGetInstance( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
...
CMPIStatus OSBase_CSNetworkPortProviderCreateInstance( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
           const CMPIObjectPath * cop, 
...
CMPIStatus OSBase_CSNetworkPortProviderSetInstance( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
           const CMPIObjectPath * cop,
           const CMPIInstance * ci, 
...
CMPIStatus OSBase_CSNetworkPortProviderDeleteInstance( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
           const CMPIObjectPath * cop) {
  CMPIStatus rc = {CMPI_RC_OK, NULL}; 
...
CMPIStatus OSBase_CSNetworkPortProviderExecQuery( CMPIInstanceMI * mi, 
           const CMPIContext * ctx, 
           const CMPIResult * rslt, 
           const CMPIObjectPath * ref, 
           const char * lang, 
...
CMPIStatus OSBase_CSNetworkPortProviderAssociationCleanup( CMPIAssociationMI * mi,
           const CMPIContext * ctx, CMPIBoolean terminate) {
...
CMPIStatus OSBase_CSNetworkPortProviderAssociators( CMPIAssociationMI * mi,
           const CMPIContext * ctx,
           const CMPIResult * rslt,
           const CMPIObjectPath * cop,
  ...
  if( ( assocClass==NULL ) || ( CMClassPathIsA(_broker,op,assocClass,&rc) == 1 ) ) {
	...
	refrc = _assoc_create_refs_1toN(_broker, ctx, rslt, cop, 
					_ClassName,_RefLeftClass,resultClass,
					_RefLeft,_RefRight,
					1, 1, &rc);
	goto exit;
      }
...
CMPIStatus OSBase_CSNetworkPortProviderAssociatorNames( CMPIAssociationMI * mi,
           const CMPIContext * ctx,
           const CMPIResult * rslt,
           const CMPIObjectPath * cop,
           const char * assocClass,
...
CMPIStatus OSBase_CSNetworkPortProviderReferences( CMPIAssociationMI * mi,
           const CMPIContext * ctx,
           const CMPIResult * rslt,
           const CMPIObjectPath * cop,
           const char * assocClass,
...
CMPIStatus OSBase_CSNetworkPortProviderReferenceNames( CMPIAssociationMI * mi,
           const CMPIContext * ctx,
           const CMPIResult * rslt,
           const CMPIObjectPath * cop,
           const char * assocClass,
...
CMInstanceMIStub( OSBase_CSNetworkPortProvider, 
                  OSBase_CSNetworkPortProvider, 
                  _broker, 
                  CMNoHook);

CMAssociationMIStub( OSBase_CSNetworkPortProvider, 
                     OSBase_CSNetworkPortProvider, 
                     _broker, 
                     CMNoHook);
...
/* ---------------------------------------------------------------------------*/
/*               end of cmpiOSBase_CSNetworkPortProvider                      */
/* ---------------------------------------------------------------------------*/
